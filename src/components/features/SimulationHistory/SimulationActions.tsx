...
export function SimulationActions({ goalName, onDelete, onViewDetails }: SimulationActionsProps) {
  return (
    <div className="border-border flex w-full items-center border-t pt-4 sm:w-auto sm:justify-evenly sm:gap-3 sm:border-l sm:border-t-0 sm:pl-5 sm:pt-0">
      <Button
      ...
      <Button
        className="sm:border-border sm:bg-secondary-button flex-1 justify-center text-xs sm:flex-none sm:gap-2.5 sm:rounded-2xl sm:border sm:px-4 sm:py-2"
        variant="ghost"
        icon={ExternalLink}
